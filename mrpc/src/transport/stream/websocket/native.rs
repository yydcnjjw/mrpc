...
impl Stream<WebSocketStream<MaybeTlsStream<TcpStream>>> {
...
impl Stream<NextLayer>
where
    NextLayer: Stream<tungstenite::Message>,
{
...
impl<NextLayer> futures::Stream for Transport<NextLayer>
where
    NextLayer: AsyncRead + AsyncWrite + Unpin,
{
    type Item = Result<Message, <WebSocketStream<NextLayer> as futures::Stream<>>::Error>;
...
impl<NextLayer> futures::Sink<Message> for Transport<NextLayer>
where
    NextLayer: AsyncRead + AsyncWrite + Unpin,
{
